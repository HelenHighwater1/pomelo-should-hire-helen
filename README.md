...
- Renders a choropleth map of every US county colored by maternal care access level (desert, low, moderate, adequate) using temporary HRSA AHRF data (awaiting March of Dimes figures)
...
County-level maternal care access data uses temporary data from HRSA's [Area Health Resources Files (AHRF)](https://data.hrsa.gov/). I am waiting on actual figures from March of Dimes. Counties are classified as a maternity care desert, low access, moderate access, or adequate access based on the number of OB clinicians and birthing facilities relative to population.
